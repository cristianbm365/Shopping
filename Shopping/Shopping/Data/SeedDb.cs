...
namespace Shopping.Data
{
    public class SeedDb
    {
        ...
        {
            await _context.Database.EnsureCreatedAsync(); // crea la db y aplica las migraciones
            await CheckCategoriesAsync();
            await CheckCountriesAsync();
            await CheckRolesAsync();
            await CheckUserAsync("1010", "Cristian", "Bedoya", "cristianbm@yopmail.com", "3508847326", "Calle Luna Calle Sol", "Cristian.jpg", UserType.Admin);
            await CheckUserAsync("2020", "Bob", "Mesa", "bobm@yopmail.com", "3508847326", "Calle Luna Calle Sol", "Bob.jpg", UserType.User);
